        ...
        <div className="container-custom max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {/* Support Topics */}
              <div>
                <h3 className="heading-3 mb-6">How can we help?</h3>
                <div className="space-y-4">
                  {supportTopics.map((topic, index) => (
                    <Card key={index} className="card-interactive p-4 group">
                      <div className="flex items-start space-x-4">
                        <div className={`w-12 h-12 ${topic.bgColor} rounded-lg flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}>
                          <topic.icon className={`w-6 h-6 ${topic.color}`} />
                        </div>
                        <div>
                          <h4 className="heading-4 mb-1">{topic.title}</h4>
                          <p className="body-small">{topic.description}</p>
                        </div>
                      </div>
                    </Card>
                  ))}
