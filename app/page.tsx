        ...
        <div className="container-custom text-center relative">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button asChild size="lg" className="text-lg px-8 py-6 bg-transparent border-2 border-white text-white hover:bg-white hover:text-indigo-600 transition-all duration-300 font-semibold shadow-none">
                <Link href="/pricing">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-3">
                {[
                  {
                    label: "Instagram",
                    href: "https://www.instagram.com/evelina.anglu_kalba?igsh=NnV6bjU3N3V2cXdp&utm_source=qr",
